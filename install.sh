...
URL="https://github.com/Free-Guy-IR/subscription-template/releases/${RELEASE_PATH}/${LANG_CODE}.html"
if [[ "${LANG_CODE}" == "fa" ]]; then
  URL="https://github.com/Free-Guy-IR/subscription-template/releases/${RELEASE_PATH}/index.html"
fi
